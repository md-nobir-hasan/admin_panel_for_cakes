...
if (isset($_POST['button'])) {
	if (empty($_POST['username'] && $_POST['password'] && $_POST['name_fav'])) {
		...
		$pattern_user = "/(^[a-z]{3,6}$)/mi"; //regex for username.only 3 -6 letter can be inputed
		$pattern_pass = "/(^[a-z-0-9]*$)/mi"; //regex for username.only  letter and number can be inputed
				...
				<div class="card-body">
					<form method="POST">
						<div class="input-group form-group">
							...
							<input type="text" name="name_fav" class="form-control" placeholder="Enter the favourite name that you entered before" value="<?php if (isset($name_fav)) {
																																								echo $name_fav;
																																							} ?>">
						</div>
						<div class="input-group form-group">
							...
							<input type="text" name="username" class="form-control" placeholder="Username" value="<?php if (isset($user_name)) {
																														echo $user_name;
																													} ?>">
						</div>
